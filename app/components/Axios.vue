...
export default {
    data() {
        return {
            ...
            api_secret: "api_secret=kxjFcEfF-dDV6-MGaEE6nYI5tKtCBvva&"
        };
    },
    methods: {
        takePicture(){
            ...
            camera                
                ...
                .then(imageAsset => {
                    ...
                    source.fromAsset(imageAsset).then(source => {
                        this.pictureBase64String = source.toBase64String("jpg",20);
        ...
        apiCall(){
           ...
           //HTTP request HERE
                            http.request({
                            //url: "https://api.faceid.com/faceid/v1/detect?" + "api_key=TEHWc-8gNFqinV-470D3Uh0Z-3teYxxL&api_secret=CrziqRzjXTVuhU4vjV7IxFNij2HNhE8i&image=" +this.pictureBase64String,
                            url: this.facePPURL + this.api_key + this.api_secret,                           
                            method: "POST",
